...
<html>
                    ...
                    <div class="row">
                        ...
                        <div id="navbar" class="collapse navbar-collapse navbar-right">
                            <ul class="nav navbar-nav">
                                ...
                                ?>
                                        <li><a href="index.php">Inicio</a></li>
                                        <li class="active"><a href="date.php">Citas</a></li>
                                        <li><a href="store.php">Tienda</a></li>
    ...
    <center> </br></br>
        ...
        <tbody>
            ...
            $consulta = "SELECT * FROM cita WHERE nombreCliente='$nombreU' AND apellidosCliente='$apellidosU' ORDER BY fechaCita ASC, horaCita ASC";
            ...
            ?>
                <tr>
                    ...
                    <td> <a href="php/deleteDate.php?idCita=<?php echo $row['idCita']; ?>" style="color:#FF0000;">Cancelar</a> </td>
                </tr>
            <?php
            }
            ?>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-box">
                                    ...
                                    <div class="form-bottom">
                                        <form role="form" action="php/date.php" class="login-form" method="POST">
                                            ...
                                            <div class="input-group form-group">
                                                <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                <input type="number" class="form-control" name="valEdadMascota" placeholder="Edad de la mascota (meses)" aria-describedby="basic-addon1">
                                            </div>
                                            <div class="input-group form-group">
                                                <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                <input type="number" step="any" class="form-control" name="valPesoMascota" placeholder="Peso de la mascota" aria-describedby="basic-addon1">
                                            </div>
