                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-box">
                                    ...
                                    <div class="form-bottom">
                                        <form role="form" action="php/updateDate.php?idCita=<?php echo $row['idCita']; ?>" class="login-form" method="POST">
                                            <div class="input-group form-group">
                                                <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                <input type="text" class="form-control" name="valNombreCliente" placeholder="Nombre del dueño" aria-describedby="basic-addon1" value=<?php echo $row['nombreCliente']; ?> required>
                                            </div>
                                            <div class="input-group form-group">
                                                <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                <input type="text" class="form-control" name="valApellidosCliente" placeholder="Apellidos del dueño" aria-describedby="basic-addon1" value=<?php echo $row['apellidosCliente']; ?> required>
                                            </div>
                                            <div class="input-group form-group">
                                                <span class="input-group-addon" id="basic-addon1"><i class="fa fa-phone"></i></span>
                                                <input type="tel" name="valNoTelefono" class="form-control" placeholder="Número de teléfono" aria-describedby="basic-addon1" minlength="10" maxlength="10" value=<?php echo $row['telefonoCliente']; ?> required>
                                            </div>
                                            <div class="input-group form-group">
                                                <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                <input type="text" class="form-control" name="valNombreMascota" placeholder="Nombre de la mascota" aria-describedby="basic-addon1" value=<?php echo $row['nomMascota']; ?> required>
                                            </div>
                                            <div class="input-group form-group">
                                            ...
                                            <div class="input-group form-group">
                                                <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                <input type="number" class="form-control" name="valEdadMascota" placeholder="Edad de la mascota (meses)" aria-describedby="basic-addon1" value=<?php echo $row['edadMascota']; ?>>
                                            </div>
                                            <div class="input-group form-group">
                                                <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                <input type="number" class="form-control" name="valPesoMascota" placeholder="Peso de la mascota" aria-describedby="basic-addon1" value=<?php echo $row['pesoMascota']; ?>>
                                            </div>
                                            <div class="form-group">
                                                <label>Padecimiento de la mascota</label>
                                                <textarea name="valPadecimiento" id="message" required="required" class="form-control" rows="3"> <?php echo $row['padecimiento']; ?> </textarea>
                                            </div>
                                            <div class="input-group form-group">
                                                <span class="input-group-addon" id="basic-addon1"><i class="fa fa-pencil"></i></span>
